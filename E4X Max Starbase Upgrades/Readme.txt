...
This is a minimod for the Enhanced 4X Mod, compatible with Star Wars Interregnum. It increases the number of Starbase upgrade points to 20, more the enough to max out all upgrades on each Starbase.
