...
This minimod disables The Imperial Warlords Faction. It may be used in combination with any other "Disable <SpecificFactionName>" minimods, as long as at least one faction is still available.

DO NOT use with "INT Disable Vanilla Factions".

This minimod does not change how the map generates, so random encounters or Minor Factions featuring Imperial units may still appear.
...
enabledModName "INT Disable Warlords"
